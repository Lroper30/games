...
function addItems() {
    ...
    platforms.forEach(function(platform) {
        // Assuming platforms are evenly spaced
...
function createDVDLogo() {
    dvdLogo = game.add.sprite(300, 300, 'dvdLogo');
    dvdLogo.scale.set(0.2);
    game.physics.arcade.enable(dvdLogo);
    dvdLogo.body.velocity.x = 300; // Increased speed
    dvdLogo.body.velocity.y = 200; // Increased speed
